...
STATICFILES_DIRS = (
    ...
    PROJECT_PATH + '../blog/static/css', #for css
    PROJECT_PATH + '../blog/static/javascript', # for javascript
)
...
SECRET_KEY = 'h%&amp;#01r6i=%i5bn!k7_6j&amp;1#$nu41hag@74rtl+flxbh^+x7gq'
